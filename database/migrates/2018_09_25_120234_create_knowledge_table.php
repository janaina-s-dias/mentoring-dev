...
class CreateKnowledgeTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('knowledges', function (Blueprint $table) {
            ...
            $table->integer('knowledge_nivel')->default(1); //1. basico 2. pouco conhecimento 3. conhecimento mediano 4. conhecimento quase pleno 5. conhecimento pleno 6. bastante conhecimento 7. experiente no assunto 8. MESTRE NO ASSUNTO
            ...
            $table->integer('knowledge_limit')->default(5);
