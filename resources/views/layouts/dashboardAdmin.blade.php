    ...
    <div class="sidebar-ce">
        ...
        <div class="list-ce">
            <ul class="navlist-ce">
                ...
                <li {{ (Request::is('*Profissoes') ? 'class="active"' : '') }}><a href="{{ url ('Profissoes') }}"><i class="fa fa-user fa-fw"></i>Profissoes</a></li>
                <li {{ (Request::is('*Carreiras') ? 'class="active"' : '') }}><a href="{{ url ('Carreiras') }}"><i class="fa fa-user fa-fw"></i>Carreiras</a></li>
                <li {{ (Request::is('*Assuntos') ? 'class="active"' : '') }}><a href="{{ url ('Assuntos') }}"><i class="fa fa-user fa-fw"></i>Assuntos</a></li>
                <li {{ (Request::is('*userSubjects') ? 'class="active"' : '') }}><a href="{{ url ('AssuntosUsuarios') }}"><i class="fa fa-user fa-fw"></i>Assuntos Usuários</a></li>
                <li {{ (Request::is('*users') ? 'class="active"' : '') }}><a href="{{ url ('Usuarios') }}"><i class="fa fa-user fa-fw"></i>Usuarios</a></li>
                <li {{ (Request::is('*Contatos') ? 'class="active"' : '') }}><a href="{{ url ('Contatos') }}"><i class="fa fa-user fa-fw"></i>Contatos</a></li>
                <li {{ (Request::is('*mentoresAdmin') ? 'class="active"' : '') }}><a href="{{ url ('mentoresAdmin') }}"><i class="fa fa-user fa-fw"></i>Mentores</a></li>
                <li {{ (Request::is('*conteudos') ? 'class="active"' : '') }}><a href="{{ url ('conteudos') }}"><i class="fa fa-user fa-fw"></i>Conteudos</a></li>
            </ul>
        </div>        
