                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('*cadastroAssunto') ? 'class="active"' : '') }}>
                            <a href="{{ url ('cadastroAssunto') }}"><i class="fa fa-dashboard fa-fw"></i> Cadastrar Assunto</a>
                        </li>
                        <li {{ (Request::is('*alterarPerfil') ? 'class="active"' : '') }}>
                            <a href="{{ url ('alterarPerfil') }}"><i class="fa fa-dashboard fa-fw"></i> Alterar Perfil</a>
                        </li>
                        <li {{ (Request::is('*alterarSenha') ? 'class="active"' : '') }}>
                            <a href="{{ url ('alterarSenha') }}"><i class="fa fa-dashboard fa-fw"></i> Alterar Senha</a>
                        </li>
